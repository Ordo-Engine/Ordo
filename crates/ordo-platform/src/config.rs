...
/// | `ORDO_PLATFORM_DIR` | Data directory for platform state | required |
...
pub struct PlatformConfig {
    ...
    /// Data directory for platform state (users, orgs, projects)
    #[arg(long = "platform-dir", env = "ORDO_PLATFORM_DIR")]
