...
import type { ConceptDefinition, DecisionContract, FactDefinition } from './types';
...
export const catalogApi = {
  ...
  upsertFact(
    token: string,
    projectId: string,
    fact: Omit<FactDefinition, 'created_at' | 'updated_at'>
  ...
  upsertConcept(
    token: string,
    projectId: string,
    concept: Omit<ConceptDefinition, 'created_at' | 'updated_at'>
