  ...
  <div class="trace-runner">
    ...
    <div class="trace-runner__left">
      <div class="trace-panel">
        ...
        <textarea v-model="inputJson" class="trace-json-input" rows="14" spellcheck="false" />
        ...
        <div v-if="selectedRuleset" class="test-cases-section">
          ...
          <div v-if="testCasesExpanded" class="test-cases-list">
            ...
            >
              ...
              <t-tag v-if="tc.expect.code" size="small" class="test-case-row__tag">{{
                tc.expect.code
              }}</t-tag>
            </button>
          </div>
        ...
        <template v-if="result">
          ...
          >
            <div class="trace-result-card__code">
              ...
              <span class="trace-result-card__duration">{{
            ...
            <pre
              v-if="Object.keys(result.output ?? {}).length > 0"
              class="trace-result-card__output"
            ...
            <template v-if="expectationMatch">
              <div class="expect-divider">
                ...
                <span class="expect-label"
                  >{{ t('trace.expected') }}: {{ activeTestCase?.expect.code }}</span
                >
              </div>
            ...
            <div class="result-actions">
              <t-button size="small" variant="outline" @click="openSaveDialog">
          ...
          <div v-if="result.trace && result.trace.steps.length > 0" class="trace-steps">
            ...
            >
              ...
              <div class="trace-step__row">
                <t-icon
                  :name="stepIconName(idx, result.trace!.steps)"
                  size="14px"
                  class="trace-step__icon"
                />
      ...
      <template v-else-if="rightTab === 'history'">
        ...
        >
          ...
          <div class="history-entry__meta">
            ...
            <span class="history-entry__duration" v-if="entry.result">{{
              formatDuration(entry.result.duration_us)
            }}</span>
          </div>
        </div>
      </template>
