...
<template>
  <div class="view-page">
    <StudioPageHeader
      :title="t('releaseCenter.requestsTitle')"
      :subtitle="t('releaseCenter.requestsSubtitle')"
    >
      <template #actions>
    ...
    <div class="toolbar">
      <t-radio-group v-model="statusFilter" variant="default-filled">
        ...
        <t-radio-button value="pending_approval">{{
          t('releaseCenter.statusPendingApproval')
        }}</t-radio-button>
    ...
    <div v-if="loading" class="loading-state">
      <t-skeleton
        theme="paragraph"
        animation="gradient"
        :row-col="[{ width: '30%' }, { width: '96%' }, { width: '80%' }]"
      />
    </div>
        ...
        <div class="req-row">
          ...
          <div class="req-body">
            ...
            <div class="req-meta">
              ...
              <span class="sep">·</span>
              <span
                >{{ request.version_diff?.from_version || 'Unreleased' }} → v{{
                  request.version
                }}</span
              >
              <span class="sep">·</span>
            ...
            <div v-if="request.change_summary" class="req-summary">
          ...
          <div class="req-actions" @click.stop>
            <template v-if="request.status === 'pending_approval' && canReviewRequest(request)">
              <t-button
                ...
                theme="danger"
                size="small"
                @click="openReview('reject', request)"
              >
              ...
              <t-button
                ...
                theme="primary"
                size="small"
                @click="openReview('approve', request)"
              >
      ...
      <t-form label-align="top" :colon="false" class="dialog-form">
        ...
        <div v-if="reviewDialog.request" class="review-context">
          ...
          <div class="review-context__meta">
            ...
            <span>·</span>
            <span>
              {{ reviewDialog.request.version_diff?.from_version || 'Unreleased' }} → v{{
                reviewDialog.request.version_diff?.to_version || reviewDialog.request.version
              }}
            </span>
          </div>
          ...
          <div class="preview-kv preview-kv--3">
            ...
            <div class="kv-item">
              ...
              <strong>{{
                reviewDialog.request.request_snapshot?.affected_instance_count ??
                reviewDialog.request.affected_instance_count
              }}</strong>
            </div>
          </div>
          <div
            v-if="reviewDialog.request.release_note"
            class="review-context__summary review-context__note"
          >
